...
const html = "";
				...
				const frontmatter = {"projectURL":"https://project07-health-record.vercel.app/","githubURL":"https://github.com/hiRafa/Project07_HealthRecord","thumbnail":"project04_thumbnail","technologies":["HTML","CSS","JS","REACT","NEXT","FIREBASE","MONGODB"],"projectTitle":"Medical Records Webapp with Next.js","projectSubtitle":"Leveling up to explore the full functionalities of a powerful JS framework with Next.js and building a MVP. First time dealing with backend logic and further understanding the connection between both ends and the database.","projectBulletList":["Nextauth","Firebase & MongoDB for database","Helper functions","useRouter","Forms and User Data","Backend","Database manipulation","Light and Dark mode","React Calendar","useContext"],"thumbnail_extra":["project04_thumbnail2","project04_thumbnail3"]};
				const file = "C:/Users/rafae/OneDrive/Área de Trabalho/Programming/Projects_Year3/Project09_PortfolioAstro/src/content/projects/project04.md";
				const url = undefined;
				function rawContent() {
					return "";
				}
