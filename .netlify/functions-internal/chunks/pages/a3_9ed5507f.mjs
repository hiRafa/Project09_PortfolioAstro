...
const $$Header = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<header${addAttribute(className, "class")}${spreadAttributes(rest)} id="myHeader" data-astro-cid-3ef6ksr2><!-- <p class="absolute bottom-0">powered by Astro</p> -->${renderComponent($$result, "Image", $$Image, { "src": headerIndex ? "/Images/stars-topleft-index.svg" : "/Images/stars-topleft.svg", "width": 220, "height": 40, "format": "svg", "alt": "stars bg", "class": "absolute top-4 z-10", "data-astro-cid-3ef6ksr2": true })}<div${addAttribute(`${!headerIndex && "header-in-grid"} relative col-start-2 col-span-full grid gap-4 justify-around h-full pt-10 pr-4 max-lg:col-start-2 max-lg:col-span-10 max-md:justify-center max-md:p-0`, "class")} data-astro-cid-3ef6ksr2><img${addAttribute(headerIndex ? "/Images/stars-bottomleft-index.svg" : "/Images/stars-bottomleft.svg", "src")}${addAttribute(440, "width")}${addAttribute(450, "height")} alt="stars bg" class="absolute bottom-0 -left-6 z-10" data-astro-cid-3ef6ksr2>${headerIndex ? renderTemplate`${renderComponent($$result, "Fragment", Fragment, { "data-astro-cid-3ef6ksr2": true }, { "default": ($$result2) => renderTemplate`<section class="self-start" data-astro-cid-3ef6ksr2>${renderComponent($$result2, "H1", $$H1, { "text": "HIRASHIKI RAFAEL", "index": true, "class": "text-5xl max-xl:text-4xl max-md:text-3xl max-sm:text-2xl font-bold", "data-astro-cid-3ef6ksr2": true })}<p class="max-lg: text-sm" data-astro-cid-3ef6ksr2>Casual Dancer</p></section><section class="text-2xl max-lg:text-lg max-md:text-lg max-sm:text-base font-bold" data-astro-cid-3ef6ksr2><h2 class="pt-4 pb-4" data-astro-cid-3ef6ksr2><i class="fa-regular fa-circle" data-astro-cid-3ef6ksr2></i> Web Frontend Developer (Junior)</h2><h3 class="pb-4" data-astro-cid-3ef6ksr2><i class="fa-solid fa-moon" data-astro-cid-3ef6ksr2></i> System Developer (graduating)</h3></section><section class="" data-astro-cid-3ef6ksr2><p class="pb-6 text-xl max-lg:text-base max-md:text-sm " data-astro-cid-3ef6ksr2>
...
Artstation
</a></div></li></ul></nav>` })}` : renderTemplate`${renderComponent($$result, "Fragment", Fragment, { "data-astro-cid-3ef6ksr2": true }, { "default": ($$result2) => renderTemplate`${renderComponent($$result2, "ButtonToggleHeader", null, { "client:only": true, "client:component-hydration": "only", "data-astro-cid-3ef6ksr2": true, "client:component-path": "C:/Users/rafae/OneDrive/\xC1rea de Trabalho/Programming/Projects_Year3/Project09_PortfolioAstro/src/components/ButtonToggleHeader.tsx", "client:component-export": "default" })}${renderComponent($$result2, "RafaPic", $$RafaPic, { "class": " w-4/6 m-auto h-fit max-lg:w-6/6", "data-astro-cid-3ef6ksr2": true })}${renderComponent($$result2, "H1", $$H1, { "text": "HIRASHIKI RAFAEL", "index": false, "class": "absolute bottom-1/4 -left-10 -rotate-90 w-0 whitespace-nowrap text-3xl  max-xl:text-2xl max-lg:text-3xl max-md:text-2xl font-bold  m-auto", "data-astro-cid-3ef6ksr2": true })}<nav class="pb-16 relative z-50  max-xl:pb-20 self-end" data-astro-cid-3ef6ksr2><ul class="pr-4" data-astro-cid-3ef6ksr2>${navObj.map((ele) => renderTemplate`<li data-astro-cid-3ef6ksr2>${ele.path === "/projects2022" && renderTemplate`<p class="li-year" data-astro-cid-3ef6ksr2>2022 & 2023</p>`}<a${addAttribute(ele.path, "href")} class="text-xl max-xl:text-lg max-lg:text-xl font-bold flex flex-nowrap justify-between items-center gap-4" data-astro-cid-3ef6ksr2><p${addAttribute(`flex flex-col items-start ${pathname === ele.path && "clr-brand-orange"}`, "class")} data-astro-cid-3ef6ksr2><span class="li-projectTitle" data-astro-cid-3ef6ksr2>${ele.navTitle}</span><span class="li-role" data-astro-cid-3ef6ksr2>${ele.navSubtitle}</span></p><div class="star-container" data-astro-cid-3ef6ksr2><div${addAttribute(`star-bar ${pathname === ele.path && "big-bar clr-brand-orange"} `, "class")} data-astro-cid-3ef6ksr2></div><i${addAttribute(`fa-solid fa-diamond ${pathname === ele.path && "big-diamond clr-brand-orange"} `, "class")} data-astro-cid-3ef6ksr2></i></div></a></li>`)}</ul></nav>` })}`}</div></header>`;
...
const $$Layout = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`<html lang="en"><head><meta charset="UTF-8"><meta name="description" content="My second portfolio after my first year as a Frontend Developer made with Astro, Tailwind and Typescript. 
    ...
    So outta this world, I'm in space\`"><meta name="viewport" content="width=device-width"><link rel="icon" type="image/svg+xml" href="/favicon.svg"><meta name="generator"${addAttribute(Astro2.generator, "content")}><title>Hirashiki Rafael, Frontend Developer Nifty Journey</title><meta property="og:title" content="Hirashiki Rafael, Frontend Developer Nifty Journey"><meta property="og:type" content="website portfolio"><meta property="og:url" content="https://hirashiki-rafael-portfolio.netlify.app/"><meta property="og:description" content="My second portfolio after my first year as a Frontend Developer made with Astro, Tailwind and Typescript. 
    Shooting for the stars. 
    \`If I give it my all, will it pay off?
    Workin' overtime, no days off
    All these shootin' stars in the dark (Yeah)
