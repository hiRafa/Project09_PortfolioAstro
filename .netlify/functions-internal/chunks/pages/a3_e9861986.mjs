...
const $$Header = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const navObj = [
    ...
    {
      path: "/agendae",
      navTitle: "Works at Agendae+ (2024\u2192)",
      navSubtitle: "System Engineer (Backend)"
    },
    {
      path: "/a3",
      navTitle: "Works at A3 (2023\u2192)",
      navSubtitle: "Frontend Engineer"
    },
    {
      path: "/projects2022",
      navTitle: "Projects 2022\u21922023",
...
let lookupMap = {};
lookupMap = {"projects":{"type":"content","entries":{"agendae":"/src/content/projects/agendae.md","a3eeopf":"/src/content/projects/a3eeoPF.md","oldportfolio":"/src/content/projects/oldportfolio.md","project02":"/src/content/projects/project02.md","project01":"/src/content/projects/project01.md","project03":"/src/content/projects/project03.md","project04":"/src/content/projects/project04.md","stw":"/src/content/projects/stw.md"}}};
...
const $$CardTitle = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const url = project.data ? project.data.projectURL : project.url;
