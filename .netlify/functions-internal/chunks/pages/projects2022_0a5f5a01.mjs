...
import 'clsx';
import { $ as $$ProjectLayout } from './agendae_85cf2946.mjs';
import { g as getEntry } from './a3_b690f70a.mjs';
import 'html-escaper';
...
const $$Projects2022 = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const projects2022 = [oldportfolio, project01, project02, project03];
